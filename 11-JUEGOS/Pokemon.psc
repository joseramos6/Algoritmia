Proceso POKEMON_AMARILLO_EDITION_PSEINT_2016
	...
	Repetir
		...
		Escribir " |                                              |";
		Escribir " @----------------------------------------------@";
		Escribir sin Saltar "Eliga una opci?n : ";
		Leer opc;
	...
	Si opc=1 Entonces
		...
		Escribir " |                                              |";
		Escribir " |  ?Bienvenidos al  mundo de POK?MON!          |";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		Esperar Tecla;
		Limpiar Pantalla;
		...
		Escribir " |                                              |";
		Escribir " |  ?Pero la gente me llama el PROFESOR POK?Mon!|";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		Esperar Tecla;
		Limpiar Pantalla;
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  ?Este mundo est? habitado por unas          |";
		Escribir " |                                              |";
		Escribir " |  criaturas llamadas POK?Mon!                 |";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		Esperar Tecla;
		Limpiar Pantalla;
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  Para algunos, los POK?MON son mascotas.     |";
		Escribir " |                                              |";
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  Estudio a los POK?MON como profesi?n.       |";
		Escribir " |                                              |";
		Escribir " |                                              |";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  Pero primero dime c?mo te llamas.           |";
		Escribir " |                                              |";
		Escribir " |                                              |";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		...
		Repetir
			...
			Escribir " |                                         \/   |";
			Escribir " @----------------------------------------------@";
			Escribir Sin Saltar "Elegir la opci?n";
			leer opc1;
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  Este es mi nieto. ?l ha sido tu rival desde |";
		Escribir " |                                              |";
		Escribir " |  que eras un ni?o.                           |";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		Repetir
			Esperar Tecla;
			...
			Escribir " @----------------------------------------------@";
			Escribir " |                                              |";
			Escribir " |  ...Mmm, ?podr?as decirme c?mo se llama?     |";
			Escribir " |                                              |";
			Escribir " |                                              |";
			Escribir " |                                         \/   |";
			Escribir " @----------------------------------------------@";
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  ?Ah, s?!  !Ahora lo recuerdo!               |";
		Escribir " |                                              |";
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  ?",jugador1,"!   ?Tu propia leyenda POK?MON |";
		Escribir " |                                              |";
		Escribir " |  est? a punto de comenzar!                   |";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		Esperar Tecla;
		Limpiar Pantalla;
		...
		Escribir " @----------------------------------------------@";
		Escribir " |                                              |";
		Escribir " |  ?Te espera un mundo de sue?os y aventuras   |";
		Escribir " |                                              |";
		Escribir " |  con los POK?MON!                            |";
		Escribir " |                                         \/   |";
		Escribir " @----------------------------------------------@";
		Esperar Tecla;
		...
		si opc3==4 Entonces
			...
			Esperar 1 Segundos;
			Escribir " |    ?En la hierba viven POK?MON salvajes!     |";
			Escribir " |                                              |";
			Escribir " |                                              |";
			Escribir " @----------------------------------------------@";
			Esperar 3 Segundos;
			...
			Escribir " | OAK: Vaya...                                 |";
			Esperar 1 Segundos;
			Escribir " |  ?Necesitas a tu propio POK?MON como         |";
			Escribir " |                         protecci?n           |";
			Escribir " |                                         \/   |";
			Escribir " @----------------------------------------------@";
			Esperar Tecla;
			...
			Escribir " |                                              |";
			Esperar 2 Segundos;
			Escribir " | OAK: ?Hum? ?Qu? haces aqu? ya?               |";
			Esperar 1 Segundos;
			Escribir " |  Te dije que vinieras m?s  tarde...          |";
			Esperar 1 Segundos;
			Escribir " |  ?No importa!    Espera ah?.                 |";
			Escribir " |                                         \/   |";
			Escribir " @----------------------------------------------@";
			Esperar Tecla;
			Limpiar Pantalla;
			...
			Esperar 1 Segundos;
			Escribir " |  est? en la mesa? Se llama POK?BALL.                           |";
			Esperar 1 Segundos;
			Escribir " |  Contiene un POK?MON en su interior.         |";
			Escribir " |                                         \/   |";
			Escribir " @----------------------------------------------@";
			Esperar Tecla;
			Limpiar Pantalla;
			...
			si opc4==0 Entonces
				...
				Escribir " |                                              |";
				Escribir " |  POK?MON!                                    |";
				Escribir " |           ",enemigo1," !Ha cogido el POK?MON!|";
				Escribir " @----------------------------------------------@";
				Esperar Tecla;
				Limpiar Pantalla;
				Escribir "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
				...
				Escribir " | ",enemigo1," ?Abuelo, yo quiero ?ste!        |";
				Esperar 1 Segundos;
				Escribir " | OAK: Pero... Bueno. Vale.                    |";
				Escribir " |           Ese POK?MON es tuyo.               |";
				Escribir " @----------------------------------------------@";
				Esperar Tecla;
				Limpiar Pantalla;
				Escribir "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
				...
				Escribir " @----------------------------------------------@";
				Escribir " |                                              |";
				Escribir " | OAK: ",jugador1,", ?ste es el POK?MON que  |";
				Escribir " |  atrap? antes. Puedes tenerlo.               |";
				Escribir " |  Lo cog? en estado salvaje, asi que no es    |";
				Escribir " |  manso todav?a.                              |";
				Escribir " @----------------------------------------------@";
				Esperar Tecla;
	...
	si opc<>2 entonces
		...
		NombreAtaque[0]="Pu?o Trueno";   TipoAtaque[0]=miPokeT1[0];  pp[0]="15"; efectivo[0]="100"; Dano[0]="75";
	...
	si opc==1 o opc==4 Entonces
		Mientras Salir==Falso Hacer			
			...
			Repetir
				...
				Escribir " |  3.- LABORATORIO DE INVESTIGACI?N  de POK?MON|";
			...
			si opc3==2 entonces
				si miPoke[0]<>"" Entonces
					Repetir
						...
						Escribir "XXXXXXXXXX|                           |XXXXXXXXXX";
						Escribir "XXXXXXXXXX|                           |XXXXXXXXXX";
						Escribir "XXXXXXXXXX|   2.- Duelo 6 POK?MON     |XXXXXXXXXX";
						Escribir "XXXXXXXXXX|                           |XXXXXXXXXX";
						Escribir "XXXXXXXXXX@---------------------------@XXXXXXXXXX";
					...
					si cantidadPoke==1 Entonces
						si totalSalud==0 Entonces
							Escribir "Ve de inmediato a curar a tu Pok?mon";
							Esperar Tecla;
						FinSi
						si eneTotalSalud==0 y totalSalud>0 Entonces
							Escribir "El Pok?mon de ",enemigo1, " est? debilidato. ";
					...
					si cantidadPoke==6 Entonces
						si totalSalud==0 Entonces
							Escribir "Ve de inmediato a curar a tus Pok?mon";
							Esperar Tecla;
						FinSi
						si eneTotalSalud==0 y totalSalud>0 Entonces
							Escribir "Los Pok?mon de ",enemigo1, " estan debilidatos";
							Escribir "Ve a Curar los tuyos y curaras lo de el tambien";
							Esperar Tecla;
						FinSi
						si eneTotalSalud>0 y totalSalud==0 Entonces
							Escribir "?",jugador1, "Tus Pok?mon estan debilidatos!";
					...
					Mientras (opc6==1 o opc6==2) y (totalSalud>0 y eneTotalSalud>0) Hacer
						...
						si opc6==1 y cantidadPoke==6 Entonces
							Repetir
								...
								Escribir "";
								Escribir "";
								Escribir "                                                  Opci?n 0 VOLVER";
								leer opcMiPoke;
								start=Verdadero;
								si opcMiPoke==1 y miPokeH1[0]==0 Entonces
									Escribir "Pok?mon ",miPoke[0]," debilitado, ve al laboratorio para Curarlo"; 
									Esperar Tecla;
								FinSi								
								si opcMiPoke==2 y miPokeH2[0]==0 Entonces
									Escribir "Pok?mon ",miPoke[1]," debilitado, ve al laboratorio para Curarlo";
									Esperar Tecla;
								FinSi								
								si opcMiPoke==3 y miPokeH3[0]==0 Entonces
									Escribir "Pok?mon ",miPoke[2]," debilitado, ve al laboratorio para Curarlo"; 
									Esperar Tecla;
								FinSi								
								si opcMiPoke==4 y miPokeH4[0]==0 Entonces
									Escribir "Pok?mon ",miPoke[3]," debilitado, ve al laboratorio para Curarlo"; 
									Esperar Tecla;
								FinSi								
								si opcMiPoke==5 y miPokeH5[0]==0 Entonces
									Escribir "Pok?mon ",miPoke[4]," debilitado, ve al laboratorio para Curarlo"; 
									Esperar Tecla;
								FinSi								
								si opcMiPoke==6 y miPokeH6[0]==0 Entonces
									Escribir "Pok?mon ",miPoke[5]," debilitado, ve al laboratorio para Curarlo"; 
									Esperar Tecla;
								FinSi								
						...
						si opc6==2 Entonces
							...
							sino 	
								si cantidadPoke==1 Entonces
									Escribir jugador1," tienes que tener 6 Pok?mon para poder jugar";
									Esperar 2 Segundos;
								FinSi
								si cantidadPoke==6 Entonces
						...
						si start=Verdadero Entonces
							...
							si OpcMiPoke<>0 Entonces
								...
								si eneSaludPoke<=0 Entonces
									...
									Escribir "Pok?mon enemigo bajo de vida";
									Esperar 2 Segundos;
								Sino								
								...
								si miSaludPoke<=0 Entonces
									...
									Escribir "Pok?mon Bajo de vida ", jugador1;
									Esperar 2 Segundos;
								Sino
								...
								si miHP==Verdadero y eneHP==Verdadero Entonces
									...
									Escribir "                             |-----------------";
									Escribir "?------------------------------------------------?";
									Escribir "|   ", enemigo1, " Envi? a ",eneNombrePoke;
									Escribir "|   ";
									Escribir "?------------------------------------------------?";
									Esperar 2 Segundos;		
								FinSi
						...
						Mientras miHp==Verdadero y eneHp=Verdadero Hacer
							...
							Repetir
								...
								si opcionAtaque == 0 Entonces
									...
									Escribir "ATAQUES Pok?mon";
									Escribir "1.- ",eneNombreAtaque[0]," | Tipo : ", eneTipoA[0]," | pp : ",enePP[0],"  da?o: ", eneDano[0]; 
									Escribir "2.- ",eneNombreAtaque[1]," | Tipo : ", eneTipoA[1]," | pp : ",enePP[1],"  da?o: ", eneDano[1]; 
									Escribir "3.- ",eneNombreAtaque[2]," | Tipo : ", eneTipoA[2]," | pp : ",enePP[2],"  da?o: ", eneDano[2]; 
									Escribir "4.- ",eneNombreAtaque[3]," | Tipo : ", eneTipoA[3]," | pp : ",enePP[3],"  da?o: ", eneDano[3]; 
									Escribir "";
									Escribir "",jugador1;
									Escribir "Nombre Pok?mon:", miNombrePoke, " Nivel ", miLVL ;
									Escribir "         Tipo pokemon: ",miTipo[0],"/",miTipo[1],"      Ps: ", miSaludPoke;
									Escribir "                          Defensa: ", miDefensaPoke, "  Velocidad: ", miVelocidadPoke;
									Escribir "ATAQUES Pok?mon";
									Escribir "1.- ",miNombreAtaque[0]," | Tipo : ", miTipoA[0]," | pp : ",miPP[0],"  da?o: ", miDano[0]; 
									Escribir "2.- ",miNombreAtaque[1]," | Tipo : ", miTipoA[1]," | pp : ",miPP[1],"  da?o: ", miDano[1]; 
									Escribir "3.- ",miNombreAtaque[2]," | Tipo : ", miTipoA[2]," | pp : ",miPP[2],"  da?o: ", miDano[2]; 
									Escribir "4.- ",miNombreAtaque[3]," | Tipo : ", miTipoA[3]," | pp : ",miPP[3],"  da?o: ", miDano[3]; 								
									Esperar Tecla;
								FinSi										
							...
							Si TipoE="FUEGO" y miAtaque<>"Giro Fuego" y (eneTipo[0]<>"FUEGO" o eneTipo[1]<>"FUEGO") Entonces
								Si (miAtaque="Ascuas" o miAtaque="Lanza Llamas" o miAtaque="Pu?o Fuego") y Suerte<=30 Entonces
									estadoA="Quemado";
								FinSi
							FinSi
							...
							Si TipoE="ELECTRICO" Entonces
								si  eneTipo[0]<>"TIERRA" o eneTipo[1]<>"TIERRA" Entonces 
									...
									FinSi
									Suerte=azar[101];
									Si Suerte<=20 y miAtaque="Pu?o Trueno"  Entonces										
										estadoA="Paralizado";										
									FinSi
							...
							Si TipoE="HIELO" Entonces
								si (miAtaque="Rayo Hielo" O miAtaque="Vendisca" o  miAtaque="Pu?o Hielo") y Suerte<=29 y (eneTipo[0]<>"HIELO" o eneTipo[1]<>"HIELO") Entonces
									estadoA="Congelado";
								FinSi								
							FinSi
							...
							Si TipoX="FUEGO" y eneAtaque<>"Giro Fuego" y (miTipo[0]<>"FUEGO" o miTipo[1]<>"FUEGO") Entonces
								Si (eneAtaque="Ascuas" o eneAtaque="Lanza Llamas" o eneAtaque="Pu?o Fuego") y Suerte<=30 Entonces
									estadoE="Quemado";
								FinSi
							FinSi
							...
							Si TipoX="ELECTRICO" Entonces
								si  miTipo[0]<>"TIERRA" o miTipo[1]<>"TIERRA" Entonces 
									...
									FinSi
									Suerte=azar[101];
									Si Suerte<=20 y eneAtaque="Pu?o Trueno"  Entonces										
										estadoE="Paralizado";										
									FinSi
							...
							Si TipoX="HIELO" Entonces
								si (eneAtaque="Rayo Hielo" O eneAtaque="Vendisca" o  eneAtaque="Pu?o Hielo") y Suerte<=29 y (miTipo[0]<>"HIELO" o miTipo[1]<>"HIELO") Entonces
									estadoE="Congelado";
								FinSi								
							FinSi
							...
							si paralizadoA=Falso y paralizadoE=Falso  Entonces
								si miV >= eneV Entonces
									...
									Escribir "?",miNombrePoke, " us? ", miAtaque,"!";	
									Esperar 2 Segundos;
									si miEst<>"" Entonces
										Escribir "?mi Pok?mon ",miNombrePoke," ",miEst,"!";
										Esperar 2 Segundos;
									FinSi
									si estadoFE<>"" Entonces
										Escribir "?El Pok?mon ",eneNombrePoke," ", estadoFE,"!";
										Esperar 2 Segundos;
									FinSi
									...
									si eneSaludPoke > 0 Entonces
										...
										Escribir "?Enemigo ",eneNombrePoke, " us? ", eneAtaque,"!";
									    Esperar 2 Segundos;
										si eneEst<>"" Entonces
											Escribir "?Enemigo Pok?mon ",eneNombrePoke," ",eneEst,"!";
											Esperar 2 Segundos;
										FinSi
										si estadoFA<>"" Entonces
											Escribir "?mi Pok?mon ",miNombrePoke," ", estadoFA,"!";
											Esperar 2 Segundos;
										FinSi
							...
							si miSaludPoke==0 o eneSaludPoke==0 Entonces
								...
								si eneSaludPoke==0 Entonces
									...
									Escribir "      /_\____/_\             |-----------------";
									Escribir "?------------------------------------------------?";
									Escribir "|  ?Pok?mon ", eneNombrePoke," debilitado!";
									Esperar 1 Segundos;
								...
								si miSaludPoke==0 Entonces
									...
									Escribir "     /_\  !   /_\            |-----------------";
									Escribir "?------------------------------------------------?";
									Escribir "|  ?Tu Pok?mon ", miNombrePoke," se ha debilitado!";
									Esperar 1 Segundos;
			...
			si opc3==3 Entonces
				...
				si opc5==2 Entonces
					si cantidadPoke==1 Entonces
						Escribir "";
						Escribir "?Reiniciando PP tu Pok?mon ", jugador1,"!";
						Esperar 2 Segundos;
						Escribir "";
						Escribir "?Reiniciando PP de los Pok?mon ", enemigo1,"!";
						Esperar 2 Segundos;
						Para contX<-0 Hasta 3 Con Paso 1 Hacer						
					...
					si cantidadPoke==6 Entonces
						Escribir "";
						Escribir "?Reiniciando PP de tus Pok?mon ",jugador1,"!";
						Esperar 2 Segundos;
						Escribir "";
						Escribir "?Reiniciando PP de los Pok?mon ", enemigo1,"!";
						Esperar 2 Segundos;
				...
				si opc5==1 Entonces	
					...
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					...
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 1/8";
					Esperar Tecla;
					Limpiar Pantalla;
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					...
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 2/8";
					Esperar Tecla;
					Limpiar Pantalla;
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					...
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 3/8";
					Esperar Tecla;
					Limpiar Pantalla;
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					...
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 4/8";
					Esperar Tecla;
					Limpiar Pantalla;
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					...
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 5/8";
					Esperar Tecla;
					Limpiar Pantalla;
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					...
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 6/8";
					Esperar Tecla;
					Limpiar Pantalla;
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					...
					Escribir "|-----------------------------------------------------------------------------------------------------------|";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 7/8";
					Esperar Tecla;
					Limpiar Pantalla;
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "| N?MERO |  NOMBRE     |  TIPO 1  | TIPO 2  | SALUD   |  ATAQUE  | DEFENSA | VELOCIDAD | ESPECIAL | TOTAL   |";
					...
					Escribir "@-----------------------------------------------------------------------------------------------------------@";
					Escribir "PRESIONES CUALQUIER TECLA PARA CONTINUAR                                                             P?g 8/8";
					Esperar Tecla;
					err=0;
					Para z<-2 Hasta 6 Con Paso 1 Hacer
						...
						si p==2 Entonces
							...
							NombreAtaque[3]="Pu?o Fuego";   TipoAtaque[3]=pokemon[0] ;  pp[3]="15"; efectivo[3]="100"; Dano[3]="75";
						FinSi						
						//POKEMON 3
						si p==3 Entonces
						...
						si p==7 Entonces
							...
							NombreAtaque[1]="Ara?azo";   TipoAtaque[1]=pokemon[0] ;  pp[1]="35"; efectivo[1]="100"; Dano[1]="40";
							NombreAtaque[2]="Doble Bofeton";   TipoAtaque[2]=pokemon[0] ;  pp[2]="10"; efectivo[2]="85"; Dano[2]="15";
						...
						si p==9 Entonces
							...
							NombreAtaque[0]="?cido";   TipoAtaque[0]=pokemon[0] ;  pp[0]="30"; efectivo[0]="100"; Dano[0]="40";
						...
						si p==10 Entonces
							...
							NombreAtaque[0]="Pu?o Trueno";   TipoAtaque[0]=pokemon[0] ;  pp[0]="15"; efectivo[0]="100"; Dano[0]="75";
						...
						si p==14 Entonces
							...
							NombreAtaque[0]="Mega Pu?o";   TipoAtaque[0]=pokemon[0] ;  pp[0]="20"; efectivo[0]="85"; Dano[0]="80";
						...
						si p==16 Entonces
							...
							NombreAtaque[1]="Ara?aso";   TipoAtaque[1]=pokemon[0] ;  pp[1]="35"; efectivo[1]="100"; Dano[1]="40";
							NombreAtaque[2]="Placaje";   TipoAtaque[2]=pokemon[0] ;  pp[2]="35"; efectivo[2]="95"; Dano[2]="35";
							NombreAtaque[3]="Chirridos";   TipoAtaque[3]=pokemon[0] ;  pp[3]="40"; efectivo[3]="85"; Dano[3]="0";
						FinSi
						//POKEMON 17 
						...
						Si p==60 Entonces
							...
							NombreAtaque[0]="Psico Rayo";   TipoAtaque[0]=pokemon[1];  pp[0]="20"; efectivo[0]="100"; Dano[0]="65";
							NombreAtaque[1]="Pu?o Hielo";   TipoAtaque[1]=pokemon[0];  pp[1]="15"; efectivo[1]="100"; Dano[1]="15";
						...
						Si p==61 Entonces
							...
							NombreAtaque[2]="Mega Pu?o";   TipoAtaque[2]="NORMAL" ;  pp[2]="20"; efectivo[2]="85"; Dano[2]="80";
							NombreAtaque[3]="Rayo";   TipoAtaque[3]=pokemon[0] ;  pp[3]="15"; efectivo[3]="100"; Dano[3]="95";
						FinSi	
						//POKEMON 
						Si p==62 Entonces
							...
							NombreAtaque[0]="Ascuas";   TipoAtaque[0]= pokemon[0];  pp[0]="25"; efectivo[0]="100"; Dano[0]="40";
							NombreAtaque[1]="Lanza LLamas";   TipoAtaque[1]=pokemon[0] ;  pp[1]="15"; efectivo[1]="100"; Dano[1]="95";
							NombreAtaque[2]="Pu?o Fuego";   TipoAtaque[2]=pokemon[0] ;  pp[2]="15"; efectivo[2]="100"; Dano[2]="75";
						...
						Si p==78 Entonces 
							...
							NombreAtaque[1]="Mega Pu?o";   TipoAtaque[1]="NORMAL" ;  pp[1]="20"; efectivo[1]="85"; Dano[1]="80";
							NombreAtaque[2]="Ataque Psiquico";   TipoAtaque[2]=pokemon[0] ;  pp[2]="10"; efectivo[2]="100"; Dano[2]="90";
							NombreAtaque[3]="Amnesia";   TipoAtaque[3]=pokemon[0] ;  pp[3]="20"; efectivo[3]="100"; Dano[3]="0";
						FinSi	
						//POKEMON 
						Si p==79 Entonces
							...
							NombreAtaque[2]="Mega Pu?o";   TipoAtaque[2]=pokemon[0] ;  pp[2]="20"; efectivo[2]="85"; Dano[2]="80";
							NombreAtaque[3]="Amnesia";   TipoAtaque[3]=pokemon[0] ;  pp[3]="20"; efectivo[3]="100"; Dano[3]="0";
						FinSi
